                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="Describe el título del post">
                                </div>
                                <div class="form-group">
                                    <label for="body">Contenido del post</label>
                                    <textarea name="body" id="body" rows="10" placeholder="Escribe el texto del post" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-primary">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="excerpt" id="excerpt" placeholder="Escribe un extracto del post" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
